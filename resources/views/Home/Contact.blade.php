        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li class="nav-item"><a href="{{url('/feedback')}}"><i class="fas fa-angle-double-right"></i> Go </a></li>
                </ul>
            </div>
        </div>
    </div>
<!--  ************************* Contact Us Starts Here ************************** -->
<h2 class="p-6" style="font-size: 35px; padding-left: 100px;">Share Your FeedBack</h2>
 @if (Route::has('login'))
    @auth
<div class="p-12 contaienr-fluid" style="background-color: white; padding-top: 0px;">
            ...
            <form class="form-horizontal" role="form" action="add_feedback" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="Name" id="firstName" placeholder="Full Name" class="form-control" value="{{Auth::user()->name}}" autofocus required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="email" class="col-sm-3 control-label">Email </label>
                    <div class="col-sm-9">
                        <input type="email" name="Email"  id="email" placeholder="Email" class="form-control" value="{{Auth::user()->email}}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                       <select class="form-control select2" name="Rating" id="rate" required>
