        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li><a href="{{url('/blog')}}"><i class="fas fa-angle-double-right"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="blog-singe no-margin row">
                        ...
                        <div class="col-sm-7 blog-content-tab">
                            ...
                            <p style="text-align: justify; font-family: sans-serif;"> <i class="fas fa-angle-double-right"></i> {{$data->Blog}}</p>
