        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li class="nav-item"><a href="{{url('/allblog')}}"><i class="fas fa-angle-double-right"></i> Go </a></li>
                </ul>
            </div>
        </div>
    </div>
<!--  ************************* Contact Us Starts Here ************************** -->
<h2 class="p-6" style="font-size: 35px; padding-left: 100px;">Write Your Blog</h2>
 @if (Route::has('login'))
    @auth
<div class="p-12 contaienr-fluid" style="background-color: white; padding-top: 0px;">
            ...
            <form class="form-horizontal" role="form" action="add_blog" method="POST">
                @csrf
                ...
                <div class="form-group">
                    <label for="phoneNumber" class="col-sm-3 control-label">Your Blog </label>
                    <div class="col-sm-9">
                        <input type="text" name="Blog" placeholder="Write Your Blog" class="form-control" required>
                    </div>
                </div>
                
                <div class="p-12">
                <button type="submit" class="btn btn-primary btn-block">Send Blog</button>
                </div>
