...
<body>
    ...
    <div class="header-top">
        ...
        <div id="menu-jk" class="header-bottom">
            ...
            @auth
    <div class="p-12 contaienr-fluid" style="background-color: white;">
            <h2 class="p-6" style="font-size: 24px">Register For Donation</h2>
            <div class="p-12">
            ...
            <form class="form-horizontal" role="form" action="/add_donate" method="POST" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="Name" id="Name" placeholder="Full Name" class="form-control" value="{{Auth::user()->name}}" autofocus required>
                    </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="donate" class="col-sm-3 control-label">Amount Of Donation </label>
                    <div class="col-sm-9">
                        <input type="text" name="donateAmonut"  id="donateAmonut" value="{{$donor->Amount}}" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="token"  id="token" class="form-control" value="{{$donor->TokenNumber}}" required>
                    </div>  
                </div>
