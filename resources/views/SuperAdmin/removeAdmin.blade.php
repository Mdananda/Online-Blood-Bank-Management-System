                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">  
                                   ...
                                   <li class="nav-item">
                                        <a class="nav-link" href="{{url('/viewadmin')}}">View Admin</a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{url('/addadmin')}}">Add Admin</a>
                                    </li>
                                    <li class="nav-item active">
                                        <a class="nav-link" href="{{url('/removeadmin')}}">Remove Admin</a>
                                    </li>

                                </ul>
                                <a class="nav-btn"href="{{url('/adminpage')}}">
                                    <button class="btn btn-success">Admin Page</button>
                                </a>
                            </div>
                        </nav>
                    </div>
   ...
   <div class="page-nav no-margin row"  style="padding-bottom:5px;">
        <div class="container">
            <div class="row">
                ...
                <ul>
                    <li><a href="{{url('/redirects')}}"><i class="fas fa-home"></i>Super Admin Panel</a></li>
                    <li><a href="{{url('/redirects')}}"><i class="fas fa-angle-double-right"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>
		<div class="container-scroller" style="padding-left: 300px; padding-top: 0px;">
			<div class="p-12">
							...
							<table class="w-full-whitespace-nowrap">
								...
								<tbody>
									...
									<tr>
										...
										<td class="border px-6 py-4" style="color: blue;"><a href="{{url('/deleteadmin',$data->id)}}">Remove Admin</a></td>
										@endif
									</tr>
