...
<header class="continer-fluid ">
  ...
  <body>
  	...
  	<div class="container-scroller" style="padding-left: 30px;">
  	<div class="p-12">
							...
							<table class="w-full-whitespace-nowrap">
								...
								@foreach($data as $data)
									<tr>
										...
										<td class="border px-2 py-2">{{$data->status}}</td>
										...
										<td class="border px-6 py-4" style="color: blue;"><a href="{{url('/deletedonor',$data->id)}}">Delete</a></td>
