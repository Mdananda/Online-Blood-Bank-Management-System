            ...
            <div class="row">
                ...
                <ul>
                   <li><a href="{{url('/adminpage')}}"><i class="fas fa-home"></i>Admin Panel</a></li>
                    <li><a href="{{url('/message')}}"><i class="fas fa-angle-double-right"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <table class="w-full-whitespace-nowrap">
                                <thead>
                                    <tr class="text-left font-bold">
                                        ...
                                        <td class="border px-2 py-2">Notice</td>
                                ...
                                @foreach($message as $data)
                                    <tr>
                                        ...
                                        <td class="border px-6 py-4" style="color: blue;"><a href="{{url('/deletemessage',$data->id)}}">Delete</a></td>         
                                    </tr>
                                @endforeach
