...
<header class="continer-fluid ">
   ...
   <div class="page-nav no-margin row"  style="padding-bottom:5px;">
        <div class="container">
            <div class="row">
                <h2>All Active Token</h2>
                <ul>
                    <li><a href="{{url('/adminpage')}}"><i class="fas fa-home"></i>Admin Panel</a></li>
                    <li><a href="{{url('/admintoken')}}"><i class="fas fa-angle-double-right"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>
   ...
   <div class="container-scroller" style="padding-left: 350px; padding-top: 0px;">
    <div class="p-12">
                    <div class="overflow-hidden shadow-sm sm-rounded-lg">
                        ...
                        <div class="p-6 border-b border-gray-500">                          
                            <table class="w-full-whitespace-nowrap" style="padding-left: 200px">
                                <thead>
                                    <tr class="text-left font-bold">
                                        <td class="border px-2 py-2">Token ID</td>
                                        <td class="border px-2 py-2">Role</td>
                                ...
                                @foreach($token as $data)
                                    <tr>
                                        ...
                                        <td class="border px-6 py-4" style="color: blue;"><a href="{{url('/deletetoken',$data->id)}}">Delete</a></td>         
                                    </tr>
                                    @endforeach
