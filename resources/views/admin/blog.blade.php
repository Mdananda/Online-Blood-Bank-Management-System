        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li><a href="{{url('/adminblog')}}"><i class="fas fa-angle-double-right"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>
<!--  ************************* Contact Us Starts Here ************************** -->
  	<div class="container-scroller" style="padding-top:5px;">
  	<div class="p-12">
							...
							<table class="w-full-whitespace-nowrap">
								<thead>
									<tr class="text-left font-bold">
										...
										<td class="border px-2 py-2">Blog</td>
								...
								@foreach($blog as $data)
									<tr>
										...
										<td class="border px-2 py-2">{{$data->Blog}}</td>
										<td class="border px-6 py-4" style="color: blue;"><a href="{{url('/deleteblog',$data->id)}}">Delete</a></td>			
									</tr>
									@endforeach
