...
<header class="continer-fluid ">
    ...
    <div class="page-nav no-margin row"  style="padding-bottom:10px;">
        <div class="container">
            <div class="row">
                <h2>Add Donor</h2>
                <ul>
    ...
    <div class="p-12 contaienr-fluid" style="background-color: white; padding-top: 5px;">
			<h2 class="p-6" style="font-size: 24px">Add A New Donor</h2>
			<div class="p-12">
            ...
            <form class="form-horizontal" role="form" action="add_donor" method="POST" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="firstName" id="firstName" placeholder="Full Name" class="form-control" autofocus required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" name="email"  id="email" placeholder="Enter The Email" class="form-control" name= "email" autofocus required>
                    </div>
                </div>
