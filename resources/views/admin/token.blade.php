...
<header class="continer-fluid ">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">    
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{url('/donations')}}">Token</a>
                                    </li>
   ...
   <div class="page-nav no-margin row">
        <div class="container">
            <div class="row">
                <h2>View All Token</h2>
                <ul>
                    <!-- <li> <a href="{{url('/home')}}"><i class="fas fa-home"></i> Home</a></li> -->
                    <li class="nav-item"><a href="{{url('/adminalltoken')}}"><i class="fas fa-angle-double-right"></i> Go </a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <h2 class="p-6" style="font-size: 35px; padding-left: 100px;">Create Token Number</h2>
 @if (Route::has('login'))
    @auth
<div class="p-12 contaienr-fluid" style="background-color: white; padding-top: 0px;">
            ...
            <form class="form-horizontal" role="form" action="add_token" method="POST">
                @csrf
               <div class="form-group">
                    <label for="token" class="col-sm-3 control-label">Token Number</label>
                    <div class="col-sm-9">
                        <input type="text" name="Token_Number"  id="Token_Number" placeholder="Token Number" class="form-control" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="donate" class="col-sm-3 control-label">Amount Of Money</label>
                    <div class="col-sm-9">
                        <input type="text" name="Amount"  id="Amount" placeholder="Amount Of Money (TK)" class="form-control" required>
                    </div>
                </div>
