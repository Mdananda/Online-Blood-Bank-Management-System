							...
							<table class="w-full-whitespace-nowrap">
								...
								<tbody>
									...
									<tr>
										...
										@if($data->role=="0")
										<td class="border px-6 py-4" style="color: blue;"><a href="{{url('/deleteuser',$data->id)}}">Delete</a></td>
										@elseif($data->role=="2")
										<td class="border px-6 py-4" style="color: red;"><a>Not Allowed</a></td>
										@else
										<td class="border px-6 py-4" style="color: darkred;"><a>Not Allowed</a></td>
										@endif
									</tr>
