...
<body style="background-color: #678983;">
        <br><br><br>
              ...
              <div class="row">
                  <div class="col-md-4 m-auto">
                    <form action="calculation" method="POST">
                        @csrf
                        <div class="card" style="background-color: #002B5B">
                          <div class="card-body m-auto">
                              <h1 class="text-center text-light" style="font-size: 40px; padding-bottom: 15px;">Arithmetic Calculator</h1>
          ...
          <div class="row">
              <div class="col-md-4 m-auto">
                  ...
                  <div class="alert alert-warning" >
                      <h1 class="text-center" style="font-size: 40px; padding-bottom: 15px;">{{ session('message') }}</h1>
                  </div>
                  @endif
              </div>
          </div> 
